#' FDA Table 15: Patients With Adverse Events by Male-Specific FDA Medical Query (Narrow) and Preferred Term,
...
#' adae$FMQ01NAM <- factor(adae$FMQ01NAM, levels = c(unique(adae$FMQ01NAM),
...
#' )
#'
#' tbl <- make_table_15(adae = adae, alt_counts_df = adsl)
#' tbl
#'
#' @export
