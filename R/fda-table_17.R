#' FDA Table 17: Patients With Adverse Events by Female-Specific FDA Medical Query (Narrow) and Preferred Term, Female Safety Population, Pooled Analyses
#'
#' @details
...
#' tbl <- make_table_17(adae = adae, alt_counts_df = adsl, risk_diff = risk_diff)
#' tbl
#'
#' @export
make_table_17 <- function(adae,
                          alt_counts_df = adsl,
                          show_colcounts = TRUE,
                          arm_var = "ARM",
                          saffl_var = "SAFFL",
