#' FDA Table 44: Patients With Adverse Events by System Organ Class, FDA Medical Query (Broad,
#'   Male-Specific) and Preferred Term, Safety Population, Pooled Analysis
#'
#' @description
#' Creates FDA Table 44 showing male-specific adverse events by OCMQ (Broad scope) and
...
#'       SEX == "M",
#'       as.factor(sample(c("Erectile Dysfunction", "Gynecomastia"), dplyr::n(), replace = TRUE)),
#'       NA_character_
#'     )
#'   )
#' data <- adae |>
#'   filter(SAFFL == "Y", SEX == "M", OCMQ01SC == "BROAD") |>
