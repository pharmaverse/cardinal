---
title: FDA Table 34
subtitle: Subjects With Adverse Events by Female-Specific OCMQ (Narrow) and Preferred Term, Female Safety Population, Pooled Analysis (or Trial X)
...
set.seed(1)
adae <- rename(adae, FMQ01SC = SMQ01SC, FMQ01NAM = SMQ01NAM)
