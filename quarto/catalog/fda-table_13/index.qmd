---
title: FDA Table 13
subtitle: Subjects With Adverse Events Leading to Treatment Discontinuation by Organ System and OCMQ (Narrow), Safety Population, Pooled Analysis (or Trial X)
...
tbl <- 
  tbl_hierarchical(
    ...
    id = USUBJID,
    denominator = adsl,
    label = list(AEBODSYS = "Organ System", FMQ01NAM = "FMQ (Narrow)")
  )
