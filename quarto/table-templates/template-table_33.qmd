...
# Output table
make_table_33(table_engine = "gtsummary", df = advs, return_ard = FALSE)
```
...
# Output table
make_table_33(table_engine = NULL, df = advs, return_ard = TRUE)
```
...
### `make_table_33(table_engine = "rtables")`
...
### `make_table_33(table_engine = "gtsummary")`
