...
-   **`adae`**: `USUBJID`, `AEBODSYS`, and the variables specified by `arm_var` and `saffl_var`.
...
Source code for this function is available [here](https://github.com/pharmaverse/falcon/blob/main/R/fda-table_35.R).
