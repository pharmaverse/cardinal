...
+-----------------------+------------------------------------------------------------------+-----------------------+
| `alt_counts_df`       | (`character`) Alternative dataset used only to calculate column  | `NULL`                |
|                       | counts.                                                          |                       |
+-----------------------+------------------------------------------------------------------+-----------------------+
...
+-----------------------+------------------------------------------------------------------+-----------------------+
| `saffl_var`           | (`character`) Flag variable used to indicate inclusion in safety | `"SAFFL"`             |
|                       | population.                                                      |                       |
+-----------------------+------------------------------------------------------------------+-----------------------+
...
+-----------------------+------------------------------------------------------------------+-----------------------+
| `lbl_overall`         | (`character`) If specified, an overall column will be added to   | `NULL`                |
|                       | the table with the given value as the column label.              |                       |
+-----------------------+------------------------------------------------------------------+-----------------------+
| `risk_diff`           | (named `list`) List of settings to apply to add a risk           | `NULL`                |
|                       | difference column to the table. See                              |                       |
|                       | [tern::add_riskdiff()](https://insight                           |                       |
|                       | sengineering.github.%20io/tern/main/reference/add_riskdiff.html) |                       |
|                       | for more details. List should contain the following elements:    |                       |
|                       |                                                                  |                       |
|                       | -   `arm_x`: (required) the name of reference arm.               |                       |
|                       |                                                                  |                       |
|                       | -   `arm_y`: (required) the name of the arm to compare to the    |                       |
|                       |     reference arm.                                               |                       |
|                       |                                                                  |                       |
|                       | -   `col_label`: (optional) label to use for the risk difference |                       |
|                       |     column. Defaults to `"Risk Difference (%) (95% CI)"`.        |                       |
|                       |                                                                  |                       |
|                       | -   `pct`: (optional) whether the output should be returned as   |                       |
...
+-----------------------+------------------------------------------------------------------+-----------------------+
| `annotations`         | (named `list` of `character`) List of annotations to add to the  | `NULL`                |
|                       | table. Valid annotation types are `title`, `subtitles`,          |                       |
|                       | `main_footer`, and `prov_footer`. Each name-value pair should    |                       |
