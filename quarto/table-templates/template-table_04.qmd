...
| `display_all_column`   | (`logical`) If specified, an overall column will be added to the table .                                                                                                                                     | `NULL`                   |
| `reason_var`       | (`flag`) variable that describes the reason for discontinuation from the study.                                                                                                                                                                                       | `DCSREAS`                  |
