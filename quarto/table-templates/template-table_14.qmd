...
![](../assets/images/screenshots/table_14.png){fig-align="center" width="78%"}
...
# Pre-Processing - Create required variables (FMQ01SC, FMQ01NAM) in adae
...
-   **`adae`**: `adae` must contain the variables `SAFFL`, `USUBJID`, `AEBODSYS`, and the variables specified by `arm_var`, `fmqsc_var`, and `fmqnam_var`.
