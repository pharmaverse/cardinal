...
+------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------+
| `risk_diff`      | (named `list`) List of settings to apply to add a risk difference column to the table. See [tern::add_riskdiff()](https://insightsengineering.github.io%20/tern/main/reference/add_riskdiff.html) for more details. List should contain the following elements: | `NULL`        |
|                  |                                                                                                                                                                                                                                                                 |               |
...
Source code for this function is available [here](https://github.com/pharmaverse/falcon/blob/main/R/fda-table_18.R).
:::
