...
A list of all templates currently available in `falcon` is provided in the [Template Library Index](index-templates.qmd), with tables designed based on the [FDA Standard Safety Tables and Figures: Integrated Guide](https://downloads.regulations.gov/FDA-2022-N-1961-0046/attachment_1.pdf).
