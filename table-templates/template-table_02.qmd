...
![](images/table_02.png){fig-align="center"}
...
|:----------|:--------------------------------------------------|:----------|
| `df`             | (`data.frame`) Data (typically ADSL) required to build table.                                                                                                                                                                                                                                                                                                                                          | *No default*                                             |
| `alt_counts_df`  | (`character`) Alternative (full) dataset used only to calculate column counts.                                                                                                                                                                                                                                                                                                                         | `NULL`                                                   |
