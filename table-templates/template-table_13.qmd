...
# Output Table
make_table_13(adae = adae, alt_counts_df = adsl, pref_var = prefterm_var, min_freq = min_freq)
```
...
| `alt_counts_df`  | (`character`) Alternative (full) dataset (typically ADSL) used only to calculate column counts.                                                                                                                                                         | `NULL`                                                |
