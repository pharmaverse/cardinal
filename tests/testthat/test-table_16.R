...
test_that("Table 16 generation works with custom values", {
  result <- make_table_16(
    adae,
    adsl,
    annotations = list(
      title = paste(
        "Table 16: Patients With Adverse Events by Male-Specific FDA Medical Query (Broad) and Preferred Term,",
